      ...
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="#"><i class="fa fa-book"></i><span class="menu-title" data-i18n="nav.dash.main">Manipulasi Data</a>
          <ul class="menu-content">
            <li><a class="menu-item" href="{{url('/petugas/blumverifikasi')}}" data-i18n="nav.dash.ecommerce"><i class="fa fa-envelope"></i> Belum diverifikasi</a>
            </li>
            <li><a class="menu-item" href="{{url('/petugas/sdhverifikasi')}}" data-i18n="nav.dash.crypto"><i class="fa fa-check-square  "></i> Sudah diverifikasi</a>
            </li>
          </ul>
        </li>
