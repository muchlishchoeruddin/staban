        ...
        <div class="container-login100" style="background-image: url({{asset('login/images/bg-01.jpg')}});">
            <div class="wrap-login100" style="width:800px;">
            	<span class="login100-form-logo" >
                    <i class="fa fa-warning" style="color:#dc0;"></i>
                </span>
               <br>
				<center><h1 style="color:#fff">Halaman yang anda cari tidak ditemukan</h1>
				<p style="color:#aaa">
				Silahkan tekan <a href="#" style="color:#ffdd00" onclick="history.go(-1)">kembali</a> untuk keluar dari laman ini</center></p>
			</div>
    	</div>
    </div>
